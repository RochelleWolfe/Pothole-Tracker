...
INSERT into pothole (lat,       long,           street_add,      size, depth, severity, report_date, report_count, priority) 
        values      (41.4156, -81.9235,         28206,          4,      6,    1 ,      '2018-11-02',  1,            1  );
INSERT into pothole (lat,       long,            street_add,    size, depth, severity, report_date,  report_count, priority)
        values      (41.3750, -81.9085,         44555,          3,      1,    2,      '2018-11-02',   2,              1);
INSERT into pothole (lat,       long,           street_add,      size, depth, severity, report_date,  report_count, priority)
        values      (41.502675, -81.639509,     4567,           2,       24,  3,       '2018-11-02',  1,              1);
INSERT into pothole (lat,       long,           street_add,     size, depth, severity, report_date,  report_count, priority) 
        values      (41.503679,  -81.640754,     4567,          5,       12,    1,    '2018-11-02',  1,              1);
INSERT into pothole (lat,       long,           street_add,     size, depth, severity, report_date,  report_count, priority)
        values      (41.504681,  -81.639509,    4567,           1,      18,    2,     '2018-11-02' , 1,              1);
